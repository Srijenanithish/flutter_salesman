...
class Territory2 extends StatefulWidget {
  static const String routeName = "/Territory2";
  MyTerritory2 createState() => MyTerritory2();
}

class MyTerritory2 extends State<Territory2> {
