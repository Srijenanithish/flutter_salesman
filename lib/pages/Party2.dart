...
class Party2 extends StatefulWidget {
  static const String routeName = "/Party2";
  myParty2 createState() => myParty2();
}

class myParty2 extends State<Party2> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        centerTitle: true,
        title: Text('Party - on - Territoty 2'),
